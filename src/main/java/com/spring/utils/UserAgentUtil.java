...
import com.spring.entity.UserAgent;
...
//		String agent = "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; Trident/7.0; Touch; .NET4.0C; .NET4...";
//		UserAgent userAgent = UserAgentUtil.getUserAgent(agent);
//		System.out.println(ReflectionToStringBuilder.toString(userAgent));
//	}
}